...
# @Filename : block_ba_serial_exp_2
# @Date     : 07/27/2019 01:03:35
# @Poject   : GraphOpt
...
from impl_block_serial_2 import optimize
...
def run_dataset(paras):
    ...
    if not write_to_dir:
        ...
        log_fn = '{}_nodes_{}_deg_{}_sparsity_{:d}_trade_{}_lr_{}_{}_serial.txt'.format(DATASET, num_nodes, deg, sparsity, trade_off, learning_rate, normalize)
...
def train_mps(sparsity, trade_off, learning_rate, num_nodes, deg, normalize):
    ...
    epsilon = 1e-3
    # write_to_dir = None
    write_to_dir = '/network/rit/lab/ceashpc/share_data/GraphOpt/log/ghtp/block_ba_2'
