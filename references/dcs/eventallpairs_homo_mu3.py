...
# @Filename : eventallpairs_homo_mu3
# @Date     : 09/18/2019 10:49:13
# @Poject   : GraphOpt
...
def test_homo_dense_graph():

    np.set_printoptions(precision=6, linewidth=2000)
    path = '/network/rit/lab/ceashpc/share_data/GraphOpt/datasets/Homo_Multiplex_Genetic'
    dataset = []
    mu = 3
    ...
    for lmbd in range(1, 601, 30):  # normalize=False
        ...
        for i, instance in enumerate(dataset):
            for time in range(times):
                ...
                print('first graph, prec={:.5f}, rec={:.5f}, fm={:.5f}, iou={:.5f}, graph density={:.5f}, subgraph density={:.5f}, nodes={}, edges={}'.format(prec, rec, fm, iou, graph_density, subgraph_density, num_nodes, num_edges))
                ...
                print('second graph, prec={:.5f}, rec={:.5f}, fm={:.5f}, iou={:.5f}, graph density={:.5f}, subgraph density={:.5f}, nodes={}, edges={}'.format(prec_2, rec_2, fm_2, iou_2, graph_density_2, subgraph_density_2, num_nodes_2, num_edges_2))
