...
# @Filename : densest_charikar_2
# @Date     : 08/11/2019 08:57:07
# @Poject   : GraphOpt
# @Author   : FEI, hfut_jf@aliyun.com
# @Desc     : https://github.com/giannisnik/k-clique-graphs-dense-subgraphs
...
def greedy_degree_density(G):
    ...
    node_pos = dict((v, pos) for pos, v in enumerate(nodes)) # index sorted by degree
    nbrs = dict((v, set(neighbors(v))) for v in G) # neighbors of each node
