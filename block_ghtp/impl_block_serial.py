...
# @Filename : impl_block_serial
# @Date     : 04/08/2019 14:11:51
# @Poject   : GraphOpt
...
def optimize(instance, sparsity, trade_off, learning_rate, max_iter, epsilon=1e-3, logger=None):
    ...
    current_x = func.get_init_x_zeros() + 1e-6 # get a initialization of vector x, plus a small amount, avoid devided by zero error
    for iter in range(max_iter):
        ...
        bx_array = func.argmax_obj_with_proj_serial_acc(current_x, omega_x_list) # solve argmax problem with block coordinate asc
