...
from utils import evaluate_evo, normalize_gradient
...
def run_instance(instance, sparsity, trade_off, max_iter=100, epsilon=1e-3):
    ...
    global_prec, global_rec, global_fm, global_iou, valid_global_prec, valid_global_rec, valid_global_fm, valid_global_iou, _, _, _, _, _ = evaluate_evo(instance['subgraphs'], pred_subgraphs)
