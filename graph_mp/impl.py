...
# @Filename : impl
# @Date     : 03/26/2019 17:15:26
# @Poject   : GraphOpt
# @Author   : FEI, hfut_jf@aliyun.com
# @Desc     : implementation of Graph-MP algorithm
...
from utils import normalize_gradient, evaluate
...
def optimize(instance, sparsity, max_iter=10, epsilon=1e-3):
    """
    graph-structured matching pursuit algorithm
    :param sparsity:
    :param max_iter:
    :param learning_rate:
    :param instance:
    ...
    acc_proj_time = 0.
    func = EMS(features=instance['features'])
    current_x = func.get_init_x_random()
...
def run_instance(instance, sparsity, max_iter=100, epsilon=1e-3):
    """
    ...
    opt_x = optimize(instance, sparsity, max_iter, epsilon)
