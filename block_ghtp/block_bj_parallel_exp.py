...
# @Filename : block_bj_parallel_exp
# @Date     : 07/17/2019 21:26:16
# @Poject   : GraphOpt
...
def train_mps(sparsity, trade_off, learning_rate, tao, normalize):
    ...
    epsilon = 1e-3
    # write_to_dir = None
    write_to_dir = '/network/rit/lab/ceashpc/share_data/GraphOpt/log/ghtp/block_bj_3'
