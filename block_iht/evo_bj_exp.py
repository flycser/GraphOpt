...
def run_dataset(paras):
    ...
    for i, instance in enumerate(dataset):
        ...
        all_performance.append((global_prec, global_rec, global_fm, global_iou, refined_global_prec, refined_global_rec,
                                refined_global_fm, refined_global_iou, run_time))
...
def train_mps(sparsity, trade_off, learning_rate):
    ...
    # sparsity_list = [600, 800]
    # sparsity_list = [600, 800, 1000]
    # sparsity_list = [1200, 1400, 1600]
    # trade_off_list = [0.01, 0.005, 0.001, 0.0005]
    # trade_off_list = [0.001, 0.0005]
    # trade_off_list = [0.01, 0.005]
    # learning_rate_list = [1., 0.5]
    max_iter = 2000
    epsilon = 1e-3
    write_to_dir = '/network/rit/lab/ceashpc/share_data/GraphOpt/log/iht/evo_bj'
