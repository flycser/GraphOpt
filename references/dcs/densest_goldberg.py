...
# @Filename : densest_goldberg
# @Date     : 07/30/2019 21:10:47
# @Poject   : GraphOpt
# @Author   : FEI, hfut_jf@aliyun.com
# @Desc     : Goldberg's Algorithm for densest subgraph detection, https://github.com/varungohil/Densest-Subgraph-Discovery.git
