...
# @Filename : block_wikivote_parallel_exp
# @Date     : 07/17/2019 21:25:24
# @Poject   : GraphOpt
...
def run_dataset(paras):
    ...
    if not write_to_dir:
        ...
        log_fn = '{}_sparsity_{:d}_trade_{}_lr_{}_parallel.txt'.format(DATASET, sparsity, trade_off, learning_rate)
    ...
    for i, instance in enumerate(dataset):
        ...
        opt_x, run_time = optimize(instance, sparsity, trade_off, learning_rate, max_iter, epsilon, logger, tao=tao)
...
def train_mps(sparsity, trade_off, learning_rate, tao):
    ...
    epsilon = 1e-3
    # write_to_dir = None
    write_to_dir = '/network/rit/lab/ceashpc/share_data/GraphOpt/log/ghtp/block_wikivote'
