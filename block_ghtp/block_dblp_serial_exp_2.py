...
# @Filename : block_dblp_serial_exp_2
# @Date     : 07/28/2019 00:41:13
# @Poject   : GraphOpt
    ...
    for case_id in range(10):
        ...
        for trade_off in [x * 0.0005 for x in range(1, 2)]:
            for sparsity in spar_list:
                ...
                #     f.write("trade_off= {}, sparsity={}\n".format(trade_off, sparsity))
                log_file = None
                result_file = '/network/rit/lab/ceashpc/share_data/GraphOpt/log/ghtp/block_dblp_2/serial_{}_{}_{}_{}_{}_{}_{}_m2std_{}_new.out'.format(
