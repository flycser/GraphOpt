...
def train_mps(sparsity, trade_off, learning_rate):
    ...
    # learning_rate_list = [1., 0.5, 0.1]
    max_iter = 2000
    epsilon = 1e-3
    write_to_dir = '/network/rit/lab/ceashpc/share_data/GraphOpt/log/iht/evo_dc'
...
if __name__ == '__main__':
    ...
    # sparsity = trade_off = learning_rate = None
