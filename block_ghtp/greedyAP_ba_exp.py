...
def run_instance(case_id, procession):
    ...
    for lmbd in procession:
        for i in range(times):
            ...
            x = BFNS(first_graph, weight, lmbd, shortest_path_lengths, start_node=-1, lcc_diameter=2 * diameter, normalize=True, sort=False, verbose=False)
