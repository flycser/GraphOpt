...
# @Filename : block_ba_parallel_exp_4
# @Date     : 07/28/2019 10:01:02
# @Poject   : GraphOpt
...
def run_node():
    ...
    for case_id in range(len(dataset)):
        ...
        log_file = None
        result_file = '/network/rit/lab/ceashpc/share_data/GraphOpt/log/ghtp/block_ba_5/node_{}_{}_{}_{}_parallel.out'.format(num_nodes, deg, sparsity, trade_off)
        ...
        for case_id in range(2):
            ...
            for trade_off in [x * 0.001 for x in range(1, 2)]:
                for sparsity in spar_list:
                    log_file = None
                    result_file = '/network/rit/lab/ceashpc/share_data/GraphOpt/log/ghtp/block_ba_5/nodes_{}_blocks_{}_mu_{}_subsize_{}_{}_deg_{}_{}_parallel.out'.format(
                        num_nodes, num_blocks, mu1, true_size, true_size, deg, data_type)
